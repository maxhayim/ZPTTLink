...
def main():
    ...
    parser = argparse.ArgumentParser(prog="zpttlink", description="ZPTTLink 5.0 Zello/radio/Asterisk bridge")
    ...
    logger.info("ZPTTLink 5.0 bridge is running successfully! (Ctrl+C to exit)")
    sd_notify("READY=1")
